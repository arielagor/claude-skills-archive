...
> **STOP.** Before running the 11-section deep review, required outputs, and review report (only after Step 0 scope and mode are agreed), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/plan-ceo-review/sections/review-sections.md` and execute it
