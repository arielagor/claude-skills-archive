...
**STOP and Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/apple-release.md` FIRST**
...
> **STOP.** Before running the test suites and (if prompt files changed) the eval suites (Steps 4-6), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/tests.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

> **STOP.** Before auditing test coverage of the diff (Step 7), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/test-coverage.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

> **STOP.** Before auditing plan completion, verification, and scope drift (Step 8), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/plan-completion.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

> **STOP.** Before the pre-landing review and specialist dispatch (Step 9), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/review-army.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

> **STOP.** Before addressing Greptile review comments when a PR exists (Step 10), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/greptile.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

> **STOP.** Before the adversarial review and learnings capture (Step 11), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/adversarial.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.
...
> **STOP.** Before writing the CHANGELOG entry (Step 13), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/changelog.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.
...
> **STOP.** Before syncing docs and creating or updating the PR/MR (Steps 18-19), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/ship/sections/pr-body.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.
