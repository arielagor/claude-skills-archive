...
> **STOP.** Before running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete), Read `C:\Users\ariel\.gstack\render\claude.tmp.451297/plan-devex-review/sections/review-sections.md` and execute it
