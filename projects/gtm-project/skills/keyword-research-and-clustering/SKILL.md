...
| **Google Search Console** | Actual ranking + click data for properties | live, Ariel's account |
...
## Competition Assessment (Manual SERP Analysis + Google Search Console)

For each target keyword, analyze top 10 results via Google and check Search Console (if available for the property):
