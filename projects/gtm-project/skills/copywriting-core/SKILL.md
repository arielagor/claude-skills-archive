...
Read bootstrap context before asking questions: `strategy/brand.md` for brand, audience, offer, channels, tools, constraints, and metrics; `about/me.md` for personal voice and style signature; `content/ideas.md` and `content/calendar.md` for content planning. For voice and tone matching, also reference `/ariel-email-voice` skill for authentic voice patterns and cadence. Use legacy product-marketing context files only as fallback. Save generated drafts to `content/<platform>/drafts/YYYY-MM-DD_short-topic-slug.md`, and route durable learnings back to `strategy/brand.md`, `about/me.md`, or `content/ideas.md`.
...
1. **Banned phrase:** Never write the two-word phrase formed by "load" directly followed by a hyphen and "bearing" (the weight-supporting sense). Describe that concept in other words if needed.
2. **No em-dashes:** Newly authored text uses comma, period, parenthetical, or hyphen-with-spaces instead. No em-dashes.
3. **Voice sourcing:** Match all copy to the voice established in `about/me.md` and reinforced by the `/ariel-email-voice` skill. This is your north star for authenticity and tone.

## Check Context First

Use `strategy/brand.md` and `about/me.md` first. Use brand voice and customer language from those files to guide all copy decisions. Match the tone and cadence exemplified in `/ariel-email-voice`.
...
- **Creating copy:** [`references/patterns.md`](references/patterns.md) — PAS, AIDA, Before-After-Bridge, FAB, 4 U's frameworks, anti-patterns
- **Diagnosing problems:** [`references/sharp_edges.md`](references/sharp_edges.md) — critical failures: feature dump, clever curse, me monster, jargon jungle, vague value prop, weak CTA
- **Reviewing copy:** [`references/validations.md`](references/validations.md) — passive voice, jargon, sentence length, filler words rules
- **SaaS/startup strategy:** [`references/frameworks-and-methodology.md`](references/frameworks-and-methodology.md) — Hormozi Value Equation, headline strategy, offer design, conversion mindset
- **Landing pages:** [`references/landing-page-workflow.md`](references/landing-page-workflow.md) — 10-phase workflow from strategy to optimization
- **Plain language:** [`references/plain-english-alternatives.md`](references/plain-english-alternatives.md) — A–Z replacements for complex words
...
**→ Full 10-phase workflow:** [references/landing-page-workflow.md](references/landing-page-workflow.md)
