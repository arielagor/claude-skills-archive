...
Read bootstrap context before asking questions: `briefs\<property>.md` for property-specific value proposition and audience; `strategy/brand.md` for brand, audience, offer, and messaging; `about/me.md` for personal voice; `content/ideas.md` and `content/calendar.md` for content planning. Save generated drafts to `content/<platform>/drafts/YYYY-MM-DD_short-topic-slug.md`, and route durable learnings back to `strategy/brand.md`, `about/me.md`, or `content/ideas.md`.
