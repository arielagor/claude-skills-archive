...
Read bootstrap context before asking questions: `briefs\<property>.md` for property-specific channels and tracking needs; `strategy/brand.md` for brand, audience, offer, and metrics; `about/me.md` for personal voice. UTM tracking integrates with Plausible analytics (dashboard at app.plausible.io) for campaign performance attribution. Use Dub.co (app.dub.co/agor) for URL shortening while preserving UTM parameters. Save generated drafts to `content/<platform>/drafts/YYYY-MM-DD_short-topic-slug.md`, and route durable learnings back to `strategy/brand.md`, `about/me.md`, or `content/ideas.md`.
...
- **Dub.co** (primary) - Tracks clicks, preserves UTMs, Plausible integration, custom branded domains via agor account
- **Rebrandly** - Custom branded domains
- **Short.io** - Team features

Example workflow:
1. Generate full UTM URL
2. Shorten with Dub.co (app.dub.co/agor)
3. Use short URL in social posts
4. UTMs tracked in Plausible analytics dashboard
