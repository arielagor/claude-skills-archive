...
3. **Outward actions are draft-gated:** Press releases, media pitches, and any outreach produce drafts only. No skill in this vault auto-sends or auto-publishes. Ariel's explicit go is a separate, later step.
